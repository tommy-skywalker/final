...
import 'package:ovorideuser/data/controller/ride/complete_ride/complete_ride_controller.dart';
    ...
    return GetBuilder<CompleteRideController>(builder: (controller) {
      return Column(
        ...
        children: [
          ...
          Text(MyStrings.reviewForDriver.tr, style: regularDefault.copyWith(fontSize: Dimensions.fontOverLarge - 1)),
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        const CustomSvgPicture(image: MyIcons.suv, color: MyColor.bodyText, height: 10, width: 15),
