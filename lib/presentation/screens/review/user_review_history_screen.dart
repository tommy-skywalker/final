                        ...
                        child: Column(
                          children: [
                            ...
                            Align(
                              ...
                              child: Text(MyStrings.driverReviews.tr, style: boldOverLarge.copyWith(fontWeight: FontWeight.w400, color: MyColor.getHeadingTextColor())),
                            ),
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              Row(
                                                ...
                                                children: [
                                                  Expanded(child: Text('${review.ride?.driver?.firstname ?? ''} ${review.ride?.driver?.lastname ?? ''}'.toCapitalized(), style: boldDefault.copyWith(color: MyColor.primaryColor))),
